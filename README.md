...
![Kafka](https://img.shields.io/badge/Kafka-7.5.0-black?logo=apachekafka)
![Docker](https://img.shields.io/badge/Docker-Enabled-blue?logo=docker)
![DeepSeek](https://img.shields.io/badge/AI-DeepSeek_R1-blueviolet)
...
1. **Dashboard**: The "Payment Service" card turns RED. The "AI SRE Agent" status changes to FIXING.
2. **AI Worker**:
   - Detects DOWN status.
   - Prompts DeepSeek: "Service failed. How do I fix it?"
   - Receives command: `docker restart payment-service`.
   - Executes command.
3. **Recovery**: The service restarts, the generator sees it coming back up, and the Dashboard turns GREEN automatically.
